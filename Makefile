...
clean:  ## Clean build files
	...
	@rm -f .coverage coverage.xml spark_plot/_generated_version.py
...
# ------------------------------------------------------------------------------
# Development, build, test and docs
...
check:  ## Check linting
	@flake8
	@isort --check-only --diff --project spark_plot --section-default THIRDPARTY .
	@black --check .


fmt:  ## Format source
	@isort --project spark_plot --section-default THIRDPARTY .
	@black .
